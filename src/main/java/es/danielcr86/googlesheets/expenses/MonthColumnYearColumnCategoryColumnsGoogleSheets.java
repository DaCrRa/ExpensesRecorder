...
import es.danielcr86.expenses.table.layout.MonthColumnYearColumnCategoryColumnsStorage;
...
public class MonthColumnYearColumnCategoryColumnsGoogleSheets implements MonthColumnYearColumnCategoryColumnsStorage {
    ...
    public MonthColumnYearColumnCategoryColumnsGoogleSheets(final GoogleSheetsOneDimensionSearcher searcher) {
